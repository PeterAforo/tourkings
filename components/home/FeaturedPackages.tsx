...
const samplePackages: Package[] = [
  {
    ...
    description: "Explore the rich history of Cape Coast Castle, Elmina Castle, and Kakum National Park canopy walkway.",
    price: 1250,
    currency: "USD",
    duration: "4 Days",
    groupSize: 12,
  ...
  {
    id: "2",
    title: "The Sands of Royalty",
    slug: "accra-city-experience",
    description: "Discover the vibrant culture of Accra with visits to Kwame Nkrumah Memorial, Jamestown, and Makola Market.",
    price: 3800,
    currency: "USD",
    duration: "7 Days",
    groupSize: 2,
  ...
  {
    id: "3",
    title: "Aegean Heritage Tour",
    slug: "volta-region-adventure",
    description: "Experience the breathtaking Mediterranean coastline with ancient ruins and iconic blue-domed architecture.",
    price: 4200,
    currency: "USD",
    duration: "10 Days",
    groupSize: 1,
